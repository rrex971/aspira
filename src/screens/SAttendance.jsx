                            ...
                            {attendance.map((row, index) => (
                                <tr key={index}>
                                    {row.map((cell, cellIndex) => (
                                        cellIndex === 3 ? <td key={cellIndex} className="border px-4 py-2">{cell ? 'Present' : 'Absent'}</td> : <td key={cellIndex} className="border px-4 py-2">{cell}</td>
                                    ))}
                                </tr>
                            ))}
                        </tbody>
...
export default transition(SAttendance);
