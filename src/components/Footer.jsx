...
const Footer = () => {
    // TODO
    return (
    <footer className="font-main px-32 py-16 space-y-4 bg-orange-peel-400 text-orange-peel-100 font-medium text-xl"> 
        <h6 className="font-bold text-2xl">ABOUT US</h6>
